							...
							<Form className="d-grid gap-3" onSubmit={formik.handleSubmit}>
								...
								<Form.Group>
									...
									<Form.Control
										...
										onChange={formik.handleChange}
									/>
									{(formik.touched.metricTons ?? false) &&
										formik.errors.declarationDate != null && (
											<small className="text-danger">{formik.errors.declarationDate}</small>
										)}
								</Form.Group>
								<hr />
